          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-4">
            {mode === "signup" && (
              <div className="flex flex-col gap-1.5">
                ...
                <Input id="name" placeholder="Meera Anand" required />
              </div>
            )}
            <div className="flex flex-col gap-1.5">
              ...
              <div className="relative">
                ...
                <Input id="email" type="email" placeholder="you@university.edu" className="pl-10" required defaultValue="meera.anand@stanford.edu" />
              </div>
            </div>
            <div className="flex flex-col gap-1.5">
